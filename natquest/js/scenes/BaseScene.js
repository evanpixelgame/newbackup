...
this.button1 = this.add.button(0, 0, 'button1').setOrigin(0); // Top-left corner within container
this.button1.setPosition(0.1, 0.2); // 10% from left, 20% from top (relative to container)
this.uiContainer.add(this.button1);
